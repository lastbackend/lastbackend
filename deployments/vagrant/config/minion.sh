...
function init_config {
    local REQUIRED=( 'ADVERTISE_IP' 'ETCD_ENDPOINTS' 'CONTROLLER_ENDPOINT' 'DNS_SERVICE_IP' 'LB_VER' 'HYPERKUBE_IMAGE_REPO' 'USE_CALICO' )
...
function init_templates {
    ...
    if [ ! -f $TEMPLATE ]; then
        ...
        cat << EOF > $TEMPLATE
[Service]
Environment=KUBELET_IMAGE_TAG=${LB_VER}
