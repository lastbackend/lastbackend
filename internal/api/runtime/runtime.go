...
func (r *Runtime) Run() {
	...
	for _, n := range []string{types.SYSTEM_NAMESPACE, types.DefaultNamespace} {
		ns, err := nm.Get(n)
		if err != nil {
			return
		}
	...
	dm := model.NewDiscoveryModel(ctx, envs.Get().GetStorage())
	dl, err := dm.List()
	if err != nil {
		return
	}
	...
	em := model.NewExporterModel(ctx, envs.Get().GetStorage())
	el, err := em.List()
	if err != nil {
		return
	}
...
func (r *Runtime) podManifestWatch(ctx context.Context, rev *int64) {
	...
	mm := model.NewPodModel(ctx, envs.Get().GetStorage())
...
func (r *Runtime) volumeManifestWatch(ctx context.Context, rev *int64) {
	...
	mm := model.NewVolumeModel(ctx, envs.Get().GetStorage())
...
func (r *Runtime) endpointManifestWatch(ctx context.Context, rev *int64) {
	...
	mm := model.NewEndpointModel(ctx, envs.Get().GetStorage())
...
func (r *Runtime) subnetManifestWatch(ctx context.Context, rev *int64) {
	...
	mm := model.NewNetworkModel(ctx, envs.Get().GetStorage())
...
func (r *Runtime) secretWatch(ctx context.Context, rev *int64) {
	...
	mm := model.NewSecretModel(ctx, envs.Get().GetStorage())
...
func (r *Runtime) configWatch(ctx context.Context, rev *int64) {
	...
	mm := model.NewConfigModel(ctx, envs.Get().GetStorage())
...
func (r *Runtime) nodeWatch(ctx context.Context, rev *int64) {
	...
	mm := model.NewNodeModel(ctx, envs.Get().GetStorage())
...
func (r *Runtime) discoveryWatch(ctx context.Context, rev *int64) {
	...
	im := model.NewDiscoveryModel(ctx, envs.Get().GetStorage())
...
func (r *Runtime) exporterWatch(ctx context.Context, rev *int64) {
	...
	im := model.NewExporterModel(ctx, envs.Get().GetStorage())
...
func (r *Runtime) ingressWatch(ctx context.Context, rev *int64) {
	...
	im := model.NewIngressModel(ctx, envs.Get().GetStorage())
...
func (r *Runtime) routeManifestWatch(ctx context.Context, rev *int64) {
	...
	im := model.NewRouteModel(ctx, envs.Get().GetStorage())
