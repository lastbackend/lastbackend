...
var (
	filter_V1_NamespaceCreate_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_V1_NamespaceCreate_0(ctx context.Context, marshaler runtime.Marshaler, client V1Client, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_V1_NamespaceCreate_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterV1HandlerServer(ctx context.Context, mux *runtime.ServeMux, server V1Server) error {
	...
	mux.Handle("GET", pattern_V1_NamespaceCreate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
var (
	pattern_V1_NamespaceCreate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "namespace"}, "", runtime.AssumeColonVerbOpt(true)))
