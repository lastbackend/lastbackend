...
func TestServiceInfo(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			fields:       fields{stg},
			want:         v1.View().Service().NewWithDeployment(s1),
			wantErr:      false,
...
func TestServiceCreate(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: check another spec parameters
		{
			...
			want:         v1.View().Service().NewWithDeployment(s2),
			wantErr:      false,
			expectedCode: http.StatusOK,
		},
		{
			...
			handler:      service.ServiceCreateH,
			data:         sm7,
			want:         v1.View().Service().NewWithDeployment(s3),
			wantErr:      false,
			expectedCode: http.StatusOK,
		},
		{
...
func TestServiceUpdate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			handler:      service.ServiceUpdateH,
			data:         sm6,
			want:         v1.View().Service().NewWithDeployment(s4),
			wantErr:      false,
			expectedCode: http.StatusOK,
		},
		{
