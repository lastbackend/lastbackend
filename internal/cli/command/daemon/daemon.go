...
func NewCommand() *cobra.Command {
	...
	cmd.Flags().StringP("api-bind-address", "", agent_config.DefaultBindServerAddress, "Set bind address for API server")
	cmd.Flags().UintP("api-bind-port", "", agent_config.DefaultBindServerPort, "Set listening port binding for API server")
	cmd.Flags().BoolP("api-tls-verify", "", false, "Enable check tls for API server")
	cmd.Flags().StringP("api-tls-ca-file", "", "", "Set path to ca file for API server")
	cmd.Flags().StringP("api-tls-cert-file", "", "", "Set path to cert file for API server")
	cmd.Flags().StringP("api-tls-private-key-file", "", "", "Set path to key file for API server")
