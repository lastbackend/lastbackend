...
//
//	log.Debugf("%s:lb.local:> dns request `lb.local.`", logPrefix)
//
//	var (
//		err error
//		v4  bool
...
//		log.Debugf("%s:lb.local:> dns.OpcodeQuery", logPrefix)
//
//		for _, q := range m.Question {
//
//			switch r.Question[0].Qtype {
//			case dns.TypeTXT:
//				log.Debugf("%s:lb.local:> get txt type query", logPrefix)
//				t := new(dns.TXT)
...
//			default:
//				log.Debugf("%s:lb.local:> get unknown query type", logPrefix)
//				fallthrough
//			case dns.TypeAAAA, dns.TypeA:
//				log.Debugf("%s:lb.local:> get A or AAAA type query", logPrefix)
//
//				if q.Name[len(q.Name)-1:] != "." {
//					q.Name += "."
//				}
//
//				log.Debugf("%s:lb.local:> find ip addresses for domain: %s", logPrefix, q.Name)
//
...
//					if len(match) != 0 {
//
//						log.Debugf("%s:lb.local:> find endpoint %s:%s", logPrefix, match[2], match[1])
//
//						e, err := em.Get(match[2], match[1])
//						if err != nil {
//							log.Errorf("%s:lb.local:> get endpoint `%s` err: %v", endpoint, logPrefix, err)
//						}
//
//						if e != nil {
...
//				}
//
//				log.Debugf("%s:lb.local:> ips list: %s for %s", logPrefix, ips, q.Name)
//
//				for _, ip := range ips {
//					v4 = ip.To4() != nil
//
...
//		} else {
//			log.Errorf("%s:lb.local:> tsig status err: %s", logPrefix, w.TsigStatus())
//		}
//	}
//
...
//		log.Errorf("%s:lb.local:> write message err: %v", logPrefix, err)
//	}
//}
