...
import (
	...
	"github.com/lastbackend/lastbackend/internal/exporter"
...
var (
	flags = []struct {
		...
		{Name: "bind-rest-address", Short: "", Value: "0.0.0.0", Desc: "Exporter REST listener address", Bind: "server.host"},
		{Name: "bind-rest-port", Short: "", Value: 2964, Desc: "Exporter REST listener port", Bind: "server.port"},
