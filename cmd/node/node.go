...
var (
	flags = []struct {
		...
		{Name: "container-image-runtime-docker-version", Short: "1.38", Value: "", Desc: "Set docker version for docker container image runtime", Bind: "container.iri.docker.version"},
