...
func (s *VendorStorage) Get(username, vendorName string) (*model.Vendor, error) {
	var (
...
func (s *VendorStorage) List(username string) (*model.VendorItems, error) {
	var (
		vendorItems = new(model.VendorItems)
