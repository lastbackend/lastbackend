...
func (AccountService) Insert(db adapter.IStorage, username, userID, password, salt string) (*string, *e.Err) {
...
func (AccountService) Get(db adapter.IStorage, username string) (*model.Account, *e.Err) {
	//var err error
