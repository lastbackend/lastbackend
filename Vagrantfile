...
Vagrant.configure("2") do |config|
  ...
  #kubernetes should be already ready so let build and run lastbackend
  config.vm.provision :file, :source => LASTBACKEND_CONFIG_PATH, :destination => "/home/core/.lastbackend/config.yml"
