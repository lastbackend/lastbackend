...
There is several types of cluster management for cluster connected to clontrol panel:
- WEB UI
- CLI
...
There is many options how you can get local last.backend cluster. The most popular are described here:
...
For creation local development environment we suggest you to use docker-machine provision type:
