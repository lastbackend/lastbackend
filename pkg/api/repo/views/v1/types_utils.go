...
func (n *Repo) ToJson() ([]byte, error) {
	return json.Marshal(n)
}

func (n *Repo) DrawTable() {
	var labels []string
...
func NewList(obj types.RepoList) *RepoList {
	p := RepoList{}
	if obj == nil {
		return nil
	}
...
func (ns *RepoList) ToJson() ([]byte, error) {
