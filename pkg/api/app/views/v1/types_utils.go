...
func (n *App) ToJson() ([]byte, error) {
	return json.Marshal(n)
}

func (n *App) DrawTable() {
	var labels []string
...
func NewList(obj types.AppList) *AppList {
	p := AppList{}
	if obj == nil {
		return nil
	}
...
func (ns *AppList) ToJson() ([]byte, error) {
