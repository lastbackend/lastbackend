...
func (p *Volume) ToMeta(obj types.VolumeMeta) VolumeMeta {
	meta := VolumeMeta{}
	meta.Name = obj.Name
...
func (p *Volume) ToSpec(obj types.VolumeSpec) VolumeSpec {
	spec := VolumeSpec{}
...
func (p *Volume) ToStatus(obj types.VolumeStatus) VolumeStatus {
	state := VolumeStatus{
		State:   obj.State,
		Message: obj.Message,
		Status: VolumeState{
