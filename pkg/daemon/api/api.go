...
var Routes = []http.Route{
	...
	{Path: "/vcs/{vendor}/repos", Method: http.MethodGet, Middleware: []http.Middleware{middleware.Context}, Handler: routes.VCSRepositoriesListH},
	{Path: "/vcs/{vendor}/branches", Method: http.MethodGet, Middleware: []http.Middleware{middleware.Context}, Handler: routes.VCSBranchesListH},

	// Build handlers
	{Path: "/build", Method: http.MethodGet, Middleware: []http.Middleware{middleware.Context}, Handler: routes.BuildListH},
	{Path: "/build", Method: http.MethodPost, Middleware: []http.Middleware{middleware.Context}, Handler: routes.BuildCreateH},
	...
	//{ Path: "/project/{project}/service/{service}/activity", Method: http.MethodGet, Middleware: []http.Middleware{middleware.Context}, Handler: routes.ServiceActivityListH},
	//{ Path: "/project/{project}/service/{service}/hook", Method: http.MethodPost, Middleware: []http.Middleware{middleware.Context}, Handler: routes.ServiceHookCreateH},
	//{ Path: "/project/{project}/service/{service}/hook", Method: http.MethodGet, Middleware: []http.Middleware{middleware.Context}, Handler: routes.ServiceHookListH},
	//{ Path: "/project/{project}/service/{service}/hook/{hook}", Method: http.MethodDelete, Middleware: []http.Middleware{middleware.Context}, Handler: routes.ServiceHookRemoveH},
	//{ Path: "/project/{project}/service/{service}/logs", Method: http.MethodGet, Middleware: []http.Middleware{middleware.Context}, Handler: routes.ServiceLogsH},
