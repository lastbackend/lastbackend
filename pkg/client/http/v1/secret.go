...
func (sc *SecretClient) Create(ctx context.Context, opts *rv1.SecretManifest) (*views.Secret, error) {
...
func (sc *SecretClient) Get(ctx context.Context) (*views.Secret, error) {
...
func (sc *SecretClient) List(ctx context.Context) (*views.SecretList, error) {

	var s *views.SecretList
	var e *errors.Http
...
func (sc *SecretClient) Update(ctx context.Context, opts *rv1.SecretManifest) (*views.Secret, error) {
